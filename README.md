...
【图片4：显示`insmod`和`lsmod`命令验证驱动成功加载的结果】
...
【图片5：显示`dmesg`命令输出的日志信息，其中包含“Hello, World!”】
...
【图片6：显示`rmmod`卸载模块后`dmesg`日志中的“Goodbye, World!”消息】
